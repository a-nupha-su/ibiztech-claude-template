...
echo "  .claude/skills/archify/                ← system flow diagram generator (tech + user journey/role)"
...
echo "  2. เจน flow ด้วย skill archify (บังคับก่อนเขียนโค้ด):"
echo "     tech → docs/02-architecture.md · user journey ต่อ role → docs/06-ux-ui-design.md"
echo "  3. เปิด docs/07-implement-plan.md → แตก FR เป็น task code"
if [ "$TYPE" = "2" ]; then
  echo "  4. เปิด docs/05-api-spec.md → วาง API contract ก่อน implement"
fi
echo ""
